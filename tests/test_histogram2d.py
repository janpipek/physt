...
class TestCalculateFrequencies(object):
    def test_simple(self):
        bins = [[0, 1, 2], [0, 1, 2]]
        frequencies, missing, errors2 = histogram2d.calculate_frequencies(vals, ndim=2, bins=bins)
    ...
    def test_errors(self):
        ...
        frequencies, missing, errors2 = histogram2d.calculate_frequencies(vals, ndim=2, bins=bins, weights=weights)
